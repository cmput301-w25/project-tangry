...
public class OfflineSyncManagerEmulatorTest {
    ...
    public static void setupClass() {
        // Configure Firebase to use emulators before any Firestore instances are created.
    ...
    public void setup() {
        ...
        // Get the Firestore instance (already configured to use the emulator via EmulatorTestHelper).
        ...
        // Create a fake network monitor. Pass the context to the base class constructor.
        fakeNetworkMonitor = new FakeNetworkMonitor(context);
        fakeNetworkMonitor.setConnected(false); // Start offline.

        // Instantiate OfflineSyncManager with our fake network monitor and real controller.
    ...
    // A test listener that calls a provided Runnable when a SYNCED status is reported.
