...
public class ImageHelper {
    ...
    /**
     * Uploads an image file to Firebase Storage and returns its download Uri via callback.
     *
     * @param imageUri   The Uri of the image to upload.
     * @param onSuccess  Callback with the download Uri upon successful upload.
     * @param onFailure  Callback for handling any errors.
     */
    public static void uploadImage(Uri imageUri,
        ...
        imageRef.putFile(imageUri)
                .addOnSuccessListener(taskSnapshot ->
                        imageRef.getDownloadUrl().addOnSuccessListener(onSuccess)
